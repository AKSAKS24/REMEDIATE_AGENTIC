...
from app.agents.sort_agent.sort_pattern_loader import load_rag_patterns
from app.agents.sort_agent.sort_utils import scan_code_for_patterns, add_pwc_tag
...
RAG_FILE = os.getenv(
    "RAG_FILE",
    os.path.join(ROOT, "sort_patterns.json")
)
...
class SortABAPRemediationAgent:
    id = "sort_abap"
